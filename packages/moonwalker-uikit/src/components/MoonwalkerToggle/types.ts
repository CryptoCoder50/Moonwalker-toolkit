...
export type MoonwalkerToggleTheme = {
...
export interface MoonwalkerToggleProps extends InputHTMLAttributes<HTMLInputElement> {
  scale?: Scales;
  checked?: boolean;
}
...
export const scaleKeys = {
  moonwalkerSize: "moonwalkerSize",
  travelDistance: "travelDistance",
  toggleHeight: "toggleHeight",
  toggleWidth: "toggleWidth",
  moonwalkerThickness: "moonwalkerThickness",
  moonwalkerTwoOffset: "moonwalkerTwoOffset",
  moonwalkerThreeOffset: "moonwalkerThreeOffset",
  butterTop: "butterTop",
